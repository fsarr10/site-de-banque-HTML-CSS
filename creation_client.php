        ...
        <div class='collapse navbar-collapse' id='navbarNav'>
            <ul class='navbar-nav ml-auto container justify-content-end'>
                <li class='nav-item active'>
                    <a href="index.html"><button class='btn btn-dark rounded-pill' type='submit'>Accueil</button></a>
                </li>
            </ul>
        </div>
    </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($check_result->num_rows > 0) {
        ...
        if ($insert_result === TRUE) {
            ...
            echo '<p>Redirection vers la <a href="client.html">accueil</a>...</p>';
            header("refresh:3;url=client.html");  // Redirection après 3 secondes
        } else {
